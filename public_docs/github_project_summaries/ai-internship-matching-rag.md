...
The project does not include real personal resumes, phone numbers, email addresses, WeChat IDs, private application records, or sensitive personal documents in the public repository. Real personal materials should be stored only in a local private\_data folder, which is excluded from Git version control.
